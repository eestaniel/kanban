...
const SideNav = () => {
  ...
  return (
    <>
      {isSidePanelOpen && (
        <nav className='side-nav-container tablet-component'>
          <div className="side-nav-board-group">
            <BoardSelector />
          </div>
          <div className='side-nav-toggle-group board-list-subgroup' onClick={toggleSidePanel}>
