 ...
 * @property {string} task_data.error - The error message for task validation.
 *
 * Functions:
    ...
    setTaskData(prevData => ({
      ...
      task_data: {
        ...
        subtasks: prevData.task_data.subtasks.map((subtask, i) =>
          i === index ? { ...subtask, title: newTitle, error: validateInput(newTitle, 'Subtask Title') } : subtask
        )
      }
    }));
  }, [validateInput]);
    ...
    <div className="task-container">
      ...
      <form action="" className="task-form">
        <CustomTextField
          ...
          error={taskData.task_data.error}
        />
        <CustomTextField
          id="task-description"
          label="Description"
