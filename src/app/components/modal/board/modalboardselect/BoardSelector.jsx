    ...
    <>
      ...
      {boardCount > 0 &&
        <div className="board-list-group">
          ...
          {boards.map(board => (
            <div className={`board-list-subgroup ${activeBoard.board_id === board.board_id && 'active-selector'}`}
                 key={board.board_id}
            ...
            >
              ...
              <h3 className="heading-m" key={board.board_id}>{board.board_data.title}</h3>
            </div>
          ))}
        </div>
