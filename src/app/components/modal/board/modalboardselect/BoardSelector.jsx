 ...
 * This component is responsible for rendering the board selector component
 * It can be used to render a list of boards and a toggle for dark mode
 * @return {JSX.Element}
 * */
